$.getJSON("quiz_content.json", function(input) {
    ...
    var buildQuiz = function () {
            ...
            var markup = {
                ...
                body: "<div class='image_box large-6 medium-6 small-12 columns'><img class='quiz_banner' src='../icons/quiz_banner.png'><img class='image' src='img/" + input[currentQuestion].image.trim() + "'><div class='credit'></div><div class='blurb'>" + input[currentQuestion].blurb + "<div class='info_source'><a target='_blank' href='" + input[currentQuestion].source + "'>See source</a></div></div></div><div class='selections large-6 medium-6 small-12 columns'><div class='question'>" + input[currentQuestion].question + "</div><div id='option-a' class='list list_long'><span class='button_box'><div class='option_button grey_button'>A</div></span><div class='option_text'>" + input[currentQuestion].a + "</div></div><div id='option-b' class='list list_long'><span class='button_box'><div class='option_button grey_button'>B</div></span><div class='option_text'>" + input[currentQuestion].b + "</div></div><div id='option-c' class='list list_long'><span class='button_box'><div class='option_button grey_button'>C</div></span><div class='option_text'>" + input[currentQuestion].c + "</div></div>",
                footer: "<div class='next'><button class='next_btn'>NEXT</button></div></div>"
            }
            if ( input[currentQuestion].d !== '' ) markup.body += "<div id='option-d' class='list list_long'><span class='button_box'><div class='option_button grey_button'>D</div></span><div class='option_text'>" + input[currentQuestion].d + "</div></div>";
